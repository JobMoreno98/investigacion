                    ...
                    <div class="col">
                        ...
                        <div class="row g-3 align-items-baseline" >
                            <div class="col-md-12">
                                ...
                                <input type="hidden" class="form-control" id="IdProyecto" name="IdProyecto" value="{{$proyecto_id}}" readonly>
                        </div>
                        </div>
                        <div class="row g-3 align-items-baseline">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea class="form-control" id="propuesta_motivos_calificacion" name="propuesta_motivos_calificacion">{{old('propuesta_motivos_calificacion')}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-baseline">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea class="form-control" id="conocimiento_motivos_calificacion" name="conocimiento_motivos_calificacion">{{old('conocimiento_motivos_calificacion')}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-baseline">
                            <div class="col-md-12">
                                <label for="problema_calificacion"><h5>3.- ¿Se expone con claridad el problema de estudio, de tal manera que los objetivos,
                                        pregunta e hipótesis se abordan de forma clara? *</h5></label>
                            </div>
                        </div>
                       <div class="row g-3 align-items-baseline">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea class="form-control" id="problema_motivos_calificacion" name="problema_motivos_calificacion">{{old('problema_motivos_calificacion')}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-baseline">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea class="form-control" id="planteamiento_motivos_calificacion" name="planteamiento_motivos_calificacion">{{old('planteamiento_motivos_calificacion')}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-baseline">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea class="form-control" id="metodologia_motivos_calificacion" name="metodologia_motivos_calificacion">{{old('metodologia_motivos_calificacion')}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-baseline">
                            <div class="col-md-12">
                                <div class="col-md-8">
                                    <input type="date" class="form-control" id="fecha_evaluacion" name="fecha_evaluacion" value="{{old('fecha_evaluacion')}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-baseline">
                            <div class="col-md-12">
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="nombre_evaluador" name="nombre_evaluador" value="{{old('nombre_evaluador')}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 align-items-baseline">
                            <div class="col-md-12">
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="codigo_evaluador" name="codigo_evaluador" value="{{old('nombre_evaluador')}}">
                                </div>
                            </div>
                        </div>
