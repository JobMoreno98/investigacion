            ...
            <form action="{{route('proyectos.store')}}" method="post" enctype="multipart/form-data" class="col-12">
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="tipo_registro" name="tipo_registro" class="form-control" onChange="cambio()">
                            <option value="Registro" selected>Registro sin apoyo económico</option>
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="justificacion_proyecto" name="justificacion_proyecto" required>{{old('justificacion_proyecto')}}</textarea>
                    </div>
                </div>
                <br>
                <div class="row g-3 align-items-center">
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="criterios_eticos" name="criterios_eticos" required>{{old('criterios_eticos')}}</textarea>
                    </div>
                </div>
                <br>
                <div class="row g-3 align-items-center">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="referencias" name="referencias" required>{{old('referencias')}}</textarea>
                    </div>
                </div>
                <br>
                <div class="row g-3 align-items-center">
